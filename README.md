...
本项目以构建一个论坛 API为主题，从零开始构建一个高性能、功能齐全的 API 程序框架。
...
产品的选型为『论坛』，但是本项目关于论坛功能的讲解占了很小的篇幅。主要是想把更多篇幅放在构建 API 和一个高效率的程序结构上。
...
GDForum 项目总共有 4800 行代码（工具 [gocloc](https://github.com/hhatto/gocloc)）：

```go
-------------------------------------------------------------------------------
Language                     files          blank        comment           code
-------------------------------------------------------------------------------
Go                             122           1009            597           4663
XML                              6              0              0            198
TOML                             1              5             21             28
Markdown                         1              0              0              1
-------------------------------------------------------------------------------
TOTAL                          130           1014            618           4890
-------------------------------------------------------------------------------
```
